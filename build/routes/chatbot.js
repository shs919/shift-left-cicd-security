...
const juicy_chat_bot_1 = __importDefault(require("juicy-chat-bot"));
...
async function initializeChatbot() {
    ...
    initializationPromise = (async () => {
        ...
        exports.bot = new juicy_chat_bot_1.default(config_1.default.get('application.chatBot.name'), config_1.default.get('application.chatBot.greeting'), trainingSet, config_1.default.get('application.chatBot.defaultResponse'));
