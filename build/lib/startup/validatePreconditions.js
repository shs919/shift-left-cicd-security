...
exports.checkIfRequiredFilePatternExists = exports.checkIfRequiredFileExists = exports.checkIfPortIsAvailable = exports.checkIfDomainReachable = exports.checkIfRunningOnSupportedCPU = exports.checkIfRunningOnSupportedOS = exports.checkIfRunningOnSupportedNodeVersion = void 0;
...
const checkIfRequiredFilePatternExists = async (directory, pattern) => {
    try {
        ...
        if (match) {
            logger_1.default.info(`Required file matching ${safe_1.default.bold(String(pattern))} is present (${safe_1.default.green('OK')})`);
            return true;
        }
        logger_1.default.warn(`Required file matching ${safe_1.default.bold(String(pattern))} is missing (${safe_1.default.red('NOT OK')})`);
        return false;
    }
    catch {
        logger_1.default.warn(`Required file matching ${safe_1.default.bold(String(pattern))} is missing (${safe_1.default.red('NOT OK')})`);
