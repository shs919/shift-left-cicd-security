...
describe('preconditionValidation', () => {
    describe('checkIfRunningOnSupportedNodeVersion', () => {
        it('should define the supported semver range as 20 - 24', () => {
            expect(package_json_1.engines.node).to.equal('20 - 24');
        ...
        it('should accept a supported version', () => {
            ...
            expect((0, validatePreconditions_1.checkIfRunningOnSupportedNodeVersion)('20.19.2')).to.equal(true);
        });
        it('should fail for an unsupported version', () => {
            expect((0, validatePreconditions_1.checkIfRunningOnSupportedNodeVersion)('25.0.0')).to.equal(false);
